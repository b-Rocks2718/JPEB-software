...
display_mandelbrot.for.0.start:
	...
	bl 1
	jmp 3
	movi r3 display_mandelbrot.end.33
	jalr r0  r3 
	movi r3 0
	sw r3  r2  -5
display_mandelbrot.end.33:
	lw r3  r2  -5
	movi r4 0
	cmp r3  r4 
	bz 1
...
display_mandelbrot.for.1.start:
	...
	bl 1
	jmp 3
	movi r3 display_mandelbrot.end.31
	jalr r0  r3 
	movi r3 0
	sw r3  r2  -7
display_mandelbrot.end.31:
	lw r3  r2  -7
	movi r4 0
	cmp r3  r4 
	bz 1
...
display_mandelbrot.end.10:
	...
	bz 1
	jmp 3
	movi r3 display_mandelbrot.else.24
	jalr r0  r3 
	lw r3  r2  -19
	movi r4 1
	add r3  r3  r4 
...
display_mandelbrot.end.18:
	...
	call draw_pixel
	sw r3  r2  -29
	movi r3 display_mandelbrot.end.29
	jalr r0  r3 
display_mandelbrot.else.24:
	lw r3  r2  -6
	sw r3  r2  -30
	lw r3  r2  -4
	sw r3  r2  -31
