...
move_obstacles.end.29:
	...
	bl 1
	jmp 3
	movi r3 move_obstacles.end.31
	jalr r0  r3 
	movi r3 0
	sw r3  r2  -25
move_obstacles.end.31:
	lw r3  r2  -25
	movi r4 0
	cmp r3  r4 
	bz 1
	jmp 3
	movi r3 move_obstacles.end.39
	jalr r0  r3 
	movi r3 450
	sw r3  r2  -26
	movi r3 10
...
move_obstacles.end.39:
	...
	bl 1
	jmp 3
	movi r3 move_obstacles.end.41
	jalr r0  r3 
	movi r3 0
	sw r3  r2  -33
move_obstacles.end.41:
	lw r3  r2  -33
	movi r4 0
	cmp r3  r4 
	bz 1
	jmp 3
	movi r3 move_obstacles.end.49
	jalr r0  r3 
	movi r3 450
	sw r3  r2  -34
	movi r3 10
...
handle_collisions.end.2:
	...
	bz 1
	jmp 3
	movi r3 handle_collisions.end.8
	jalr r0  r3 
	movi r3 1
	sw r3  r2  -4
	movi r3 obstacle_1_x
	...
	bge 1
	jmp 3
	movi r3 handle_collisions.end.6
	jalr r0  r3 
	movi r3 0
	sw r3  r2  -4
handle_collisions.end.6:
	lw r3  r2  -4
	movi r4 0
	cmp r3  r4 
	bz 1
	...
	movi r3 1
	sw r3  r2  -1
handle_collisions.end.8:
	lw r3  r2  -1
	movi r4 0
	cmp r3  r4 
	bz 1
	jmp 3
	movi r3 handle_collisions.end.14
	jalr r0  r3 
	movi r3 1
	sw r3  r2  -7
	...
	bl 1
	jmp 3
	movi r3 handle_collisions.end.11
	jalr r0  r3 
	movi r3 0
	sw r3  r2  -7
handle_collisions.end.11:
	lw r3  r2  -7
	movi r4 0
	cmp r3  r4 
	bz 1
	jmp 3
	movi r3 handle_collisions.else.12
	jalr r0  r3 
	movi r3 1
	# Function Epilogue
	mov r1  r2 
...
handle_collisions.end.14:
	...
	ble 1
	jmp 3
	movi r3 handle_collisions.end.17
	jalr r0  r3 
	movi r3 0
	sw r3  r2  -10
handle_collisions.end.17:
	lw r3  r2  -10
	movi r4 0
	cmp r3  r4 
	bz 1
	jmp 3
	movi r3 handle_collisions.end.23
	jalr r0  r3 
	movi r3 1
	sw r3  r2  -12
	movi r3 obstacle_2_x
...
handle_collisions.end.21:
	...
	movi r3 1
	sw r3  r2  -9
handle_collisions.end.23:
	lw r3  r2  -9
	movi r4 0
	cmp r3  r4 
	bz 1
	jmp 3
	movi r3 handle_collisions.end.29
	jalr r0  r3 
	movi r3 1
	sw r3  r2  -15
...
handle_collisions.end.26:
	...
	bz 1
	jmp 3
	movi r3 handle_collisions.else.27
	jalr r0  r3 
	movi r3 1
	# Function Epilogue
	mov r1  r2 
	...
	addi r1  r1  2
	jalr r0  r7 
	movi r3 handle_collisions.end.28
	jalr r0  r3 
handle_collisions.else.27:
	movi r3 score
	lw r3  r3  0
	movi r4 1
	add r3  r3  r4 
	movi r4 score
	sw r3  r4  0
handle_collisions.end.28:
handle_collisions.end.29:
	movi r3 0
	# Function Epilogue
	mov r1  r2 
	lw r7  r2  1
